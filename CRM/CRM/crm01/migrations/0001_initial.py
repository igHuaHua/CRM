# Generated by Django 2.2 on 2019-05-25 04:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', crm01.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Campuses',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('re_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm01.ClassList', verbose_name='班级')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm01.Customer', verbose_name='客户')),
                ('enrolment_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm01.ClassList', verbose_name='所报班级')),
            ],
        ),
        migrations.CreateModel(
            name='ConsultRecord',
        ...
        migrations.AddField(
            ...
            name='contract',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm01.ContractTemplate', verbose_name='选择合同模版'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
        ...
        migrations.AddField(
            ...
            name='department',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm01.Department'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='groups',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm01.CourseRecord', verbose_name='某节课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm01.Customer', verbose_name='学员')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delete_status', models.BooleanField(default=False, verbose_name='删除状态')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm01.Customer', verbose_name='客户名称')),
                ('enrolment_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm01.ClassList', verbose_name='所报班级')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm01.Campuses')),
            ],
            options={
